...
from constants import MINIMUM_ACTION_SET
...
class GameState(object):
    def __init__(self, rand_seed, display=False, no_op_max=7):
        ...
        self.real_actions = MINIMUM_ACTION_SET
    ...
    def _process_frame(self, action, reshape, frameskip=4):
        ...
        # reshaped_screen = np.reshape(gray_observation, (210, 160))
